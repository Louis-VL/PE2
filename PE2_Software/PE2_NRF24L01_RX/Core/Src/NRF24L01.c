...
void NRF24_TxMode (uint8_t *Address, uint8_t channel){
	...
	//config = config | (1<<1);	 // write 1 in the PWR_UP bit (TX MODE)
	config = config & (0xF2);    // write 0 in the PRIM_RX, and 1 in the PWR_UP, and all other bits are masked (RX MODE)
